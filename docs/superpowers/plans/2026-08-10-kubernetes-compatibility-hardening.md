...
export const ADMIN_PERMISSION_GROUPS = [
  ...
  { scope: "management", apiGroup: "apps", resources: ["replicasets"], verbs: ["get", "list"] },
  ...
  { scope: "management", apiGroup: "networking.k8s.io", resources: ["networkpolicies"], verbs: ["get", "list", "watch", "delete"] },
