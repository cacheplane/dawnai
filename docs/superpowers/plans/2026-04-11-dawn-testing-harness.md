...
Run: `pnpm --filter @dawn/devkit exec vitest --run test/reporting.test.ts`
...
Run: `pnpm --filter @dawn/devkit exec vitest --run test/generated-app.test.ts`
...
Run: `pnpm --filter @dawn/core exec vitest --run test/discover-routes.test.ts`
...
Run: `pnpm --filter @dawn/core exec vitest --run test/config.test.ts test/render-route-types.test.ts`
...
Run: `pnpm --filter @dawn/cli exec vitest --run test/verify-command.test.ts`
