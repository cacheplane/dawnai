...
- **EcosystemSection** — Fraunces H2. **Green's only home.** Eyebrow dot green. `@dawn-ai/langgraph` and `@dawn-ai/langchain` cards have green borders with a subtle green radial glow at the bottom. `@dawn-ai/sdk` stays neutral dashed. No amber in this section.
