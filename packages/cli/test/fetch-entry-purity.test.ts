...
const KNOWN_UPSTREAM_NODE_EDGES: readonly string[] = [
  ...
  "node:fs <- ../core/dist/compiler/analyze-route-tools.js",
  ...
  "node:path <- ../core/dist/compiler/analyze-route-tools.js",
  "node:path <- ../core/dist/compiler/typescript-backend.js",
...
const LOADER_EDGES: readonly string[] = [
  ...
  "typescript <- ../core/dist/compiler/typescript-backend.js",
]
