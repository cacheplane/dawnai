  ...
  return (
    <article className="docs-article">
      ...
      <div className="callout">
        <p className="panel-label">CLI command scope</p>
        <p>
          The `dawn` binary is scoped to app inspection and generated output inside an existing Dawn
          project. It does not handle deployment, framework-level orchestration, or project
          scaffolding. Today the supported command scope is `dawn check`, `dawn routes`, and `dawn
          typegen`.
        </p>
      </div>
...
dawn typegen --cwd ./my-dawn-app`}</code>
      ...
      <p>
        Scaffolding is intentionally separate because there are two distinct paths. A
        bootstrap-local scaffolding flow is useful when working inside the Dawn monorepo, while
        published scaffolding is the default path for external users installing `create-dawn-app`
