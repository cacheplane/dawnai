...
```
PASS chat quality › answers a greeting mean=1.00 [contains(help)=1.00 toolCalled(applyFilter)=0.00]
PASS chat quality › filters open items mean=1.00 [contains(help)=0.00 toolCalled(applyFilter)=1.00]
