...
Evals use the same aimock fixture system as agent tests — see [Agent Test Harness](/docs/testing-agents) for how fixtures, `script()`, and replay-vs-live mode work, and why live runs must never touch CI.
