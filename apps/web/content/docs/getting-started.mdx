...
<RelatedCards items={[
  { href: "/docs/routes", title: "Routes", subtitle: "agent, workflow, graph, chain, and middleware" },
  { href: "/docs/tools", title: "Tools", subtitle: "tool inputs, outputs, and runtime context" },
  { href: "/docs/state", title: "State", subtitle: "Zod state schemas and dynamic-segment merging" },
  { href: "/docs/cli", title: "CLI", subtitle: "every command flag and exit code" },
