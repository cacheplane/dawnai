...
<RelatedCards items={[
  ...
  { href: "/docs/deployment", title: "Deployment", subtitle: "how retry composes with dawn build output" },
  { href: "/docs/recipes/retry-flaky-tools", title: "Retry flaky tools", subtitle: "recipe applying retry policies per route" },
]} />
