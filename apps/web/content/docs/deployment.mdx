...
- [Dev Server](/docs/dev-server) — local protocol parity with production endpoints
- [Middleware](/docs/middleware) — request gating that runs identically in dev and on the platform
- [Testing](/docs/testing) — confirming parity before deploy via live-server scenarios
- [CLI](/docs/cli) — `dawn build`, `dawn verify`, and all other commands
