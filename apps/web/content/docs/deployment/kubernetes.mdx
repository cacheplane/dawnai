...
The application chart does not replace the sandbox infrastructure chart. See the existing [Execution Sandbox](/docs/sandbox) guide for the provider and cluster-side security boundary.
...
<RelatedCards
  items={[
    ...
    { href: "/docs/sandbox", title: "Execution Sandbox", description: "Configure the Kubernetes sandbox provider and infrastructure." },
