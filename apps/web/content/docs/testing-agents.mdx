...
`create-dawn-ai-app` generates `server/test/research.test.ts` that imports `@dawn-ai/testing` and covers the default `/research#agent` route. Run it immediately after scaffolding, from the workspace root:
