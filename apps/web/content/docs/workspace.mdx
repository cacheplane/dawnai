...
The `research` template (`create-dawn-ai-app --template research`) shows how these tools fit together. Paths below are relative to the Dawn app root, which is the generated workspace's `server/` package:
...
<RelatedCards items={[
  ...
  { href: "/docs/configuration", title: "Configuration Reference", subtitle: "dawn.config.ts reference including backends" },
