...
| The CLI (`dawn dev`, `dawn run`)   | LangGraph Platform deploy|
...
- [Routes](/docs/routes) — the folder-as-route convention
- [Agents](/docs/agents) — the default route entry
- [Tools](/docs/tools) — co-located tools and type inference
- [Dev Server](/docs/dev-server) — the runtime protocol
