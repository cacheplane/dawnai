...
*Capabilities* are opt-in behavior discovered from files and descriptors. `workspace/AGENTS.md` provides memory, `plan.md` provides planning, `skills/<name>/SKILL.md` provides route-local skills, and `subagents/` provides child specialists.
