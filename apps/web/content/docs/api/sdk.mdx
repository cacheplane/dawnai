...
```ts api-contract="@dawn-ai/sdk#.:ReasoningConfig"
...
```ts api-contract="@dawn-ai/sdk#.:RetryConfig"
...
```ts api-contract="@dawn-ai/sdk#.:isDawnAgent"
...
```ts api-contract="@dawn-ai/sdk#.:validateModelId"
...
```ts api-contract="@dawn-ai/sdk#.:RouteConfig"
...
```ts api-contract="@dawn-ai/sdk#.:defineMemory"
