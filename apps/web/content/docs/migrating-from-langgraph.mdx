...
- [Mental Model](/docs/mental-model) — where Dawn ends and LangGraph begins
- [Routes](/docs/routes) — the folder-as-route convention and the four entry shapes
- [Tools](/docs/tools) — co-located tools and build-time type inference
- [FAQ](/docs/faq) — the boundary at one-line resolution
